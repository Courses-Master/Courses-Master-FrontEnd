...
const navigation = [
  { name: 'Dashboard', href: '/Admin-home', current: true },
                ...
                {navigation.map((item) => (
                  <Link
                    ...
                    className={classNames(
                      location.pathname === item.href  ? 'bg-[#15B79E] text-white text-2xl' : 'text-[#15B79E] text-2xl hover:bg-[#15B79E] duration-700 hover:text-white',
