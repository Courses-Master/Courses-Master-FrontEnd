...
export default function EventsAdminSidebar() {
    ...
    const menuItems = {
        mainNav: [
            { title: "Dashboard", icon: FileChartPie, url: "/Admin-home" },
            { title: "Manage Events", icon: CalendarPlus2, url: "/events" },
            { title: "Attendee Insights", icon: Users, url: "/attendee-insights" },
            { title: "Analytics & Reports", icon: ChartSpline, url: "#" },
        ],
        support: [
            { title: "Contact Support", icon: FileChartPie, url: "#" },
            { title: "Notifications", icon: CalendarPlus2, url: "#" },
            { title: "Settings", icon: null, url: "#" },
        ],
        features: [
            { title: "Marketing", icon: FileChartPie, url: "#" },
            { title: "Event Categories", icon: null, url: "#" },
        ],
        account: [
            { title: "Manage Users", icon: FileChartPie, url: "#" },
        ...
        <SidebarProvider className="w-fit bg-black text-white !border-none">
            ...
            <Sidebar collapsible="icon" className={`relative h-full w-fit transition-all duration-1000 ${sidebarOpen ? "w-fit" : "w-0 overflow-hidden"
                ...
                <div className="bg-black text-white p-2">
                    <Button variant="ghost" className="w-full !flex justify-start gap-4 h-11 p-5 bg-[#282828]/80 rounded-[10px]">
                        <span className="bg-[#C1FF72] w-9 h-9 rounded-[10px] flex justify-center items-center">
                            <Plus className="!w-6 !h-6" color="white" />
                        </span>
                        <div onClick={() => navigate("/events/add-event")} className="text-start cursor-pointer">
                            <h2 className="text-[15px]">Add Quick Event</h2>
                ...
                <SidebarContent className="bg-black relative border-r-transparent">
                    ...
                    {renderSidebarGroup("Support & Management", menuItems.support, "support")}
                    {renderSidebarGroup("Features", menuItems.features, "features")}
