...
export default function EventList({ events, setSearchText, setEvents }) {
            ...
            <div className="bg-white rounded-2xl">
                ...
                <div className="flex flex-wrap justify-between items-center  p-4 rounded-lg shadow-md mb-6">
                    ...
                    <div className="flex gap-3">
                        <Button onClick={() =>navigate("/events/add-event")} className=" border border-[#0122F5] cursor-pointer text-[#0122F5] rounded-[15px]"><CirclePlus />New Event</Button>
                        <Button onClick={() =>navigate("/attendee-insights")} variant="outline" className="text-orange-500 cursor-pointer border-orange-500">
                            Attendee Insights
                        </Button>
                    </div>
                ...
                {events.length > 0 ? events.map((event, index) => (
                    <div key={index} className="bg-white group  cursor-default p-4 rounded-lg shadow hover:shadow-lg transition">
                        <div className="flex justify-between">
                            ...
                            <DropMenu setEvents={setEvents} id={event.id} />
                        </div>
